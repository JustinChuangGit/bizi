...
class vendorHomeHeader extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                  right: width * 0.05, left: width * 0.05, top: width * 0.02),
              child: Divider(
...
class _LineChartSample2State extends State<LineChartSample2> {
  List<Color> gradientColors = [
    ...
    colorConstants.biziGreen.withOpacity(0.0),
  ];
...
class _LineChart extends StatelessWidget {
  ...
  LineChartBarData get lineChartBarData2_3 => LineChartBarData(
        isCurved: true,
        curveSmoothness: 0,
        color: colorConstants.biziGreen.withOpacity(0.5),
        barWidth: 2,
        isStrokeCapRound: true,
